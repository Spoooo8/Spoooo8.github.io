  ...
  const projects = [
    ...
    },
    {
      ...
      techStack: ['React', 'SpringBoot', 'Postgres', 'Docker'],
       link: 'https://unilink-xi.vercel.app/',
      repo: 'https://github.com/Spoooo8/unilink-be',
    },
        {
      ...
      repo: 'https://github.com/Spoooo8/simple-idp-be'
    },
    {
      ...
      techStack: ['OpenCV'],
      link: '#',
      repo: 'https://github.com/Spoooo8/Malaria-Diagnosis', 
    },
  ];
